...
// IsMSIEnabled checks if VM Managed Service Identity should be used for authentication
// MSI must be explicitly configured in the config
func (cfg *Config) IsMSIEnabled() bool {
	return cfg.IsMIConfigured()
}
