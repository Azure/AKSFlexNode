...
func (o *nspawnNodeOperator) ApplyGoalState(ctx context.Context, log *slog.Logger, goal aksmachine.GoalState) (*State, error) {
	...
	_, gs, containerImageArchives, err := ResolveMachineGoalState(ctx, log, o.cfg, newMachine, &goal)
	if err != nil {
	...
	tasks := phases.Serial(log,
		...
		StartNode(o.cfg, log, newMachine, gs, containerImageArchives, o.state, newState),
