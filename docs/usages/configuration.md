...
| `azure.servicePrincipal.clientSecretFile` | string | Path to a protected file containing the application client secret. Mutually exclusive with `clientSecret`. | `/run/credentials/aks-flex-node-sp` |
