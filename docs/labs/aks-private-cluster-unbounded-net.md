...
>
> **Validated scope:** Private API access, Site assignment, node readiness, workload startup, `kubectl exec`, and `kubectl logs`. The bootstrap-token-only path doesn't validate durable Azure Machine reconciliation.
>
